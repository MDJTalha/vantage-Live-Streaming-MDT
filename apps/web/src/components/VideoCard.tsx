    ...
    >
      ...
      {isSpeaking && !isLocal && (
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 rounded-2xl border-4 border-success/50 animate-pulse-ring" />
        </div>
      )}
        ...
        >
          ...
          {onSpotlight && (
            <button
              ...
              title="Spotlight"
              aria-label="Spotlight this participant"
            >
          ...
          {[1, 2, 3, 4].map((bar) => (
            <div
              ...
              className={`w-1 rounded-full ${
                bar <= 3 ? 'bg-success' : 'bg-muted-foreground'
              }`}
